...
func Ace(t *testing.T, lado turnos.Lado) *ponto.Ponto {
	// Ace
...
func ServicoPlus1(t *testing.T, lado turnos.Lado) *ponto.Ponto {
	// Serviço + 1
	tu := turno.New(turno.DefinindoLado(lado))
	ConfiguraTurno(t, tu)
	p := ponto.New(tu)
...
func ServicoEWinner(t *testing.T, lado turnos.Lado) *ponto.Ponto {
	// Serviço e winner
	tu := turno.New(turno.DefinindoLado(lado))
	ConfiguraTurno(t, tu)
	p := ponto.New(tu)
...
func AvaliarPlacarPonto(t *testing.T, p *ponto.Ponto, ladoDoPonto pontos.Lado) PlacarPonto {
